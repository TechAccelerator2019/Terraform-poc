...
func (i *mockProviderInstaller) Get(provider addrs.ProviderConfig, req discovery.Constraints) (discovery.PluginMeta, tfdiags.Diagnostics, error) {
...
func (cb callbackPluginInstaller) Get(provider addrs.ProviderConfig, req discovery.Constraints) (discovery.PluginMeta, tfdiags.Diagnostics, error) {
